          ...
          <div class="modal-dialog">
            <div class="modal-content border">
              <form id="addEventForm" autocomplete="off">
                ...
                <div class="modal-footer d-flex justify-content-end align-items-center bg-light border-0"><a class="me-3 text-600" href="../app/events/create-an-event.html">More options</a><button class="btn btn-primary px-4" type="submit">Save</button></div>
              </form>
            </div>
          </div>
        </div>
...
<!-- Mirrored from prium.github.io/falcon/v3.16.0/dashboard/project-management.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Apr 2023 05:34:21 GMT -->
</html>
